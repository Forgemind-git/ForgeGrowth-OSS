...
GRANT ALL ON coexistence.media_library TO service_role;
GRANT ALL ON coexistence.media_meta_sync TO service_role;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA coexistence TO service_role;
